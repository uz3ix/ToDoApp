...
template <> constexpr inline auto AddWindow::qt_create_metaobjectdata<qt_meta_tag_ZN9AddWindowE_t>()
{
    ...
    QtMocHelpers::StringRefStorage qt_stringData {
        ...
        "taskAdded",
        "",
        "on_pushBut_HomePage_clicked",
        "connectToDB",
        "on_pushBut_creatTask_clicked"
    };

    QtMocHelpers::UintData qt_methods {
        // Signal 'taskAdded'
        QtMocHelpers::SignalData<void()>(1, 2, QMC::AccessPublic, QMetaType::Void),
        // Slot 'on_pushBut_HomePage_clicked'
        QtMocHelpers::SlotData<void()>(3, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'connectToDB'
        QtMocHelpers::SlotData<void()>(4, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'on_pushBut_creatTask_clicked'
...
void AddWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->on_pushBut_HomePage_clicked(); break;
        case 2: _t->connectToDB(); break;
        case 3: _t->on_pushBut_creatTask_clicked(); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (AddWindow::*)()>(_a, &AddWindow::taskAdded, 0))
            return;
    }
}
